...
import KnowledgeBaseList from './pages/admin/documents/KnowledgeBaseList';
            ...
            <Routes>
              ...
              <Route path="/admin" element={<ProtectedRoute allowedRoles={['admin']} />}>
                <Route element={<AdminLayout />}>
                  ...
                  <Route path="knowledge-bases/:kbId" element={<DocumentList />} />
                  <Route path="knowledge-bases/upload" element={<UploadDocument />} />
