      ...
      >
        ...
        < nav className="px-3 flex-1 overflow-y-auto space-y-1 py-4" >
          ...
          < NavLink
            ...
            className={({ isActive }) =>
              clsx(
                "flex items-center gap-3 px-4 py-3 transition-all duration-200 group text-sm font-medium border-l-4",
                isActive
                  ? "border-indigo-600 dark:border-indigo-400 bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400"
          ...
          < div className="space-y-0.5" >
            <div className="flex items-center pr-2 group">
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    "flex-1 flex items-center gap-3 px-4 py-3 transition-all duration-200 text-sm font-medium border-l-4",
                    isActive
                      ? "border-indigo-600 dark:border-indigo-400 bg-indigo-50 text-indigo-600 dark:bg-indigo-500/10 dark:text-indigo-400"
                      : "border-transparent text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white"
                  )
