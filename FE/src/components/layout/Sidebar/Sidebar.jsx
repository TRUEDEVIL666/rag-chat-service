  ...
  const NavItem = ({ to, icon: Icon, label, exact = false }) => (
    <NavLink end={exact}
      ...
      className={({ isActive }) => clsx(
        "flex items-center gap-3 px-4 py-3 transition font-medium text-sm group border-l-4",
        isActive
          ? "border-primary-600 dark:border-primary-400 bg-primary-50 text-primary-600 dark:bg-primary-900/10 dark:text-primary-400"
          : "border-transparent text-gray-500 dark:text-gray-400 hover:bg-primary-50 dark:hover:bg-primary-900/10 hover:text-primary-600 dark:hover:text-primary-400"
      )}
    >
      {({ isActive }) => (
        <>
    ...
    <>
      ...
      <aside className={clsx(
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
          <NavItem to="/admin/dashboard" icon={SquaresFourIcon} label={t('sidebar.dashboard')} exact />
          ...
          <div className="space-y-0.5">
            <div className="flex items-center pr-2 group">
              <NavLink end
                ...
                className={({ isActive }) => clsx(
                  "flex-1 flex items-center gap-3 px-4 py-3 transition font-medium text-sm border-l-4",
                  isActive
                    ? "border-primary-600 dark:border-primary-400 bg-primary-50 text-primary-600 dark:bg-primary-900/10 dark:text-primary-400"
                    : "border-transparent text-gray-500 dark:text-gray-400 hover:bg-primary-50 dark:hover:bg-primary-900/10 hover:text-primary-600 dark:hover:text-primary-400"
                )}
          ...
          <NavItem to="/admin/knowledge-bases" icon={FilesIcon} label={t('sidebar.documents')} />
        ...
        <div className="p-4 border-t border-gray-100 dark:border-gray-700">
          <button onClick={handleLogout}
            className="w-full flex items-center gap-3 px-4 py-3 text-gray-500 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 transition font-medium text-sm cursor-pointer group border-l-4 border-transparent">
