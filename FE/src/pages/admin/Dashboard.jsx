...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (setTitle) setTitle(t('admin.dashboard.title', 'Dashboard'));
  }, [setTitle, t]);

  const {
    stats, activity, topics, engagement, feedback,
    loadingStats, loadingActivity, loadingTopics, loadingEngagement, loadingFeedback,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 md:col-span-3">
            <EngagementWidget t={t} engagement={engagement} navigate={navigate} loading={loadingEngagement} />
          </div>
          <div className="col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6">
            <TrendingWidget t={t} topics={topics} loading={loadingTopics} />
            <FeedbackWidget t={t} feedback={feedback} loading={loadingFeedback} />
          </div>
        </div>
