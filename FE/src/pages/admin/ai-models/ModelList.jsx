          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-2xl border border-gray-100 dark:border-gray-700 animate-fade-in-up">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className={`btn-primary text-sm px-4 flex items-center gap-2 ${(!formData.model_id || isSubmitting) ? 'opacity-50 cursor-not-allowed' : ''}`}
                  disabled={!formData.model_id || isSubmitting}
                >
                  {isSubmitting && <SpinnerIcon className="animate-spin" size={16} />}
