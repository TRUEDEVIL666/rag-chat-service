...
class KnowledgeBaseRepository:
    ...
    def list_datasets(
        ...
        """
        Trả danh sách KB theo spec /datasets, kèm total.
        ...
        try:
            ...
            logger.exception(f"[Supabase] Failed to list datasets: {e}")
            return [], 0
    ...
    def get_dataset_detail(
            ...
            try:
                ...
                logger.exception(f"[Supabase] Failed to get dataset detail {dataset_id}: {e}")
                return None, [], {"app_count": 0, "document_count": 0, "word_count": 0}
