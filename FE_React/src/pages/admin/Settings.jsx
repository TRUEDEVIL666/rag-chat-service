  ...
  return (
    <div className="max-w-3xl space-y-8">
      <header className="mb-6">
        <h1 className="text-xl font-semibold dark:text-white">{t('admin.settings.title')}</h1>
      </header>
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('admin.settings.account.email')}</label>
            <input
              type="text"
              disabled
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('admin.settings.account.role')}</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">{t('admin.settings.account.tenant')}</label>
            <input
              type="text"
              disabled
      ...
      <div className="card relative overflow-hidden">
        <div className="absolute top-0 right-0 p-4">
          <span className="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-bold border border-yellow-200">
            {t('admin.settings.password.inDev')}
          </span>
        </div>
        ...
        <form onSubmit={(e) => { e.preventDefault(); alert(t('admin.settings.password.notSupported')); }} className="space-y-4 max-w-md">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('admin.settings.password.current')}</label>
            <input type="password" className="input-field" disabled />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('admin.settings.password.new')}</label>
            <input type="password" className="input-field" disabled />
          </div>
