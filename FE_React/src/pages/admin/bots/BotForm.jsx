          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-7">
                <div className="glass-card bg-white dark:bg-gray-800 rounded-3xl p-8 space-y-6 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <div className="lg:col-span-5">
                <div className="sticky top-6 space-y-6">
                  ...
                  <div className="glass-card bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 space-y-6">
