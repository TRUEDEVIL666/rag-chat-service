...
class UserService:
  ...
  def get_all_users(self, limit: int = 20, cursor_timestamp: int = None, search_params: Optional["UserSearchParams"] = None, access_token: str = None) -> list[dict]:
    return self.user_repo.get_users(limit=limit, cursor_timestamp=cursor_timestamp, search_params=search_params, access_token=access_token)
