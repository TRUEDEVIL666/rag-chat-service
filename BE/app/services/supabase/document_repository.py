...
class DocumentRepository:
  ...
  async def create_document(self, data: dict, access_token: str = None) -> dict | None:
    try:
  ...
  async def get_document_by_id(self, document_id: str, access_token: str = None) -> dict | None:
    try:
      client = await get_async_supabase_client(access_token)
  ...
  async def get_document_by_name(self, kb_id: str, name: str, tenant_id: str, access_token: str = None) -> dict | None:
    try:
      client = await get_async_supabase_client(access_token)
      response = await (
  ...
  async def get_documents_by_kb(self, kb_id: str, tenant_id: str, access_token: str = None) -> List[dict]:
  ...
  async def update_document_upload_success(self, document_id: str, file_path: str, access_token: str = None) -> bool:
  ...
  async def update_document_status(self, document_id: str, status: str, access_token: str = None) -> dict | None:
    try:
      client = await get_async_supabase_client(access_token)
      response = await (
          client.table(self.table_name)
  ...
  async def delete_document(self, document_id: str, access_token: str = None) -> bool:
    try:
      client = await get_async_supabase_client(access_token)
  ...
  async def count_documents_by_kb(self, kb_id: str, tenant_id: str, access_token: str = None) -> int:
  ...
  async def get_total_documents(self, access_token: str = None) -> int:
