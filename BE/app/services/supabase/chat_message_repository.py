...
class ChatMessageRepository:
  ...
  def create_message(self, session_id: str, content: str, role: str, sender_id: Optional[str] = None) -> dict | None:
    try:
      data = {
  ...
  def get_messages_by_session(self, session_id: str, limit: int = 50, offset: int = 0) -> List[dict]:
    try:
      response = (
